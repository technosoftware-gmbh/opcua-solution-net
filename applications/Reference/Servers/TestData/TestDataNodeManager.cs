...
namespace TestData
{
    ...
    public class TestDataNodeManager : UaStandardNodeManager, ITestDataSystemCallback
    {
        ...
        /// </summary>
        public TestDataNodeManager(IUaServerData server, ApplicationConfiguration configuration, string[] namespaceUris)
        :
        ...
        protected override NodeStateCollection LoadPredefinedNodes(ISystemContext context)
        {
            ...
            predefinedNodes.LoadFromBinaryResource(context, "Technosoftware.Servers.TestData.TestData.PredefinedNodes.uanodes", this.GetType().GetTypeInfo().Assembly, true);
        ...
        {
            UaServerContext serverContext = context as UaServerContext;
