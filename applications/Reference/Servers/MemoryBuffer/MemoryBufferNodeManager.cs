...
namespace MemoryBuffer
{
    ...
    public class MemoryBufferNodeManager : SampleNodeManager
    {
        ...
        protected override NodeStateCollection LoadPredefinedNodes(ISystemContext context)
        {
            ...
            predefinedNodes.LoadFromBinaryResource(context, "Technosoftware.Servers.MemoryBuffer.MemoryBuffer.PredefinedNodes.uanodes", this.GetType().GetTypeInfo().Assembly, true);
