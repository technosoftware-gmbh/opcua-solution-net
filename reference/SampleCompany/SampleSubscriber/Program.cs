...
namespace SampleCompany.SampleSubscriber
{
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (UaPubSubApplication uaPubSubApplication = UaPubSubApplication.Create(pubSubConfiguration))
                {
                    ...
                    uaPubSubApplication.RawDataReceivedEvent += UaPubSubApplication_RawDataReceived;

                    // Subscribte to DataReceived event
                    uaPubSubApplication.DataReceivedEvent += OnDataReceived;

                    // Subscribte to MetaDataReceived event
                    uaPubSubApplication.MetaDataReceivedEvent += UaPubSubApplication_MetaDataDataReceived;

                    uaPubSubApplication.ConfigurationUpdatingEvent += OnConfigurationUpdating;
        ...
        /// <summary>
        /// Handler for <see cref="UaPubSubApplication.RawDataReceivedEvent" /> event.
        /// </summary>
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void OnDataReceived(object sender, SubscribedDataEventArgs e)
        {
            lock (lock_)
            {
        ...
        /// <summary>
        /// Handler for <see cref="UaPubSubApplication.ConfigurationUpdatingEvent"/>
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private static void OnConfigurationUpdating(object sender, ConfigurationUpdatingEventArgs e)
        {
        ...
        private static DateTime timeOfConfiguration_ = new DateTime(2021, 5, 1, 0, 0, 0, DateTimeKind.Utc);
