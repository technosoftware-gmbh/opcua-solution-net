...
namespace Technosoftware.UaClient.Tests
{
    ...
    public class SubscriptionTest : ClientTestFramework
    {
        ...
        public void AddSubscription()
        {
            ...
            // save
            Session.Save(subscriptionTestXml_);
        ...
        public void LoadSubscription()
        {
            ...
            // load
            var subscriptions = Session.Load(subscriptionTestXml_);
        ...
        public async Task TransferSubscription(TransferType transferType, bool sendInitialValues)
        {
            ...
            if (transferType != TransferType.KeepOpen)
            {
                ...
                {
                    subscription.Handle = ii;
                    subscription.MonitoredItems.ToList().ForEach(i => i.MonitoredItemNotificationEvent += (object sender, MonitoredItemNotificationEventArgs e) => {
                        MonitoredItem item = (MonitoredItem)sender;
