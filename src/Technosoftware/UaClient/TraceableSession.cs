...
namespace Technosoftware.UaClient
{
    ...
    public class TraceableSession : IUaSession
    {
        ...
        {
            using (Activity activity = ActivitySource.StartActivity(nameof(FindDataDictionaryAsync)))
            {
        ...
        {
            using (Activity activity = ActivitySource.StartActivity(nameof(LoadDataTypeSystemAsync)))
            {
        ...
        public bool Republish(uint subscriptionId, uint sequenceNumber)
        {
            ...
            {
                return session_.Republish(subscriptionId, sequenceNumber);
            }
        }
        ...
        public IAsyncResult BeginReadValues(
                                ...
                                object userData)
        {
            using (Activity activity = ActivitySource.StartActivity(nameof(BeginReadValues)))
            {
        ...
        {
            using (Activity activity = ActivitySource.StartActivity(nameof(WriteValue)))
            {
        ...
        {
            using (Activity activity = ActivitySource.StartActivity(nameof(WriteValues)))
            {
        ...
        public IAsyncResult BeginWriteValues(
                                ...
                                object userData)
        {
            using (Activity activity = ActivitySource.StartActivity(nameof(BeginWriteValues)))
            {
        ...
        public List<StatusCode> EndWriteValues(
            IAsyncResult result)
        {
            using (Activity activity = ActivitySource.StartActivity(nameof(EndWriteValues)))
            {
