...
{    
    ...
    public class MqttTlsCertificates
    {
            ...
            string clientCertificatePath = null, string clientCertificatePassword = null)
        {
            ...
            m_keyValuePairs.Add(new Opc.Ua.KeyValuePair { Key = qCaCertificatePath, Value = m_caCertificatePath });

            QualifiedName qClientCertificatePath = EnumMqttClientConfigurationParameters.TlsCertificateClientCertificatePath.ToString();
            m_keyValuePairs.Add(new Opc.Ua.KeyValuePair { Key = qClientCertificatePath, Value = m_clientCertificatePath });
            ...
            m_keyValuePairs.Add(new Opc.Ua.KeyValuePair { Key = qClientCertificatePassword, Value = m_clientCertificatePassword });
        }
    ...
    public class MqttClientProtocolConfiguration : ITransportProtocolConfiguration
    {
                                               ...
                                               MqttTlsOptions mqttTlsOptions = null)
        {
            ...
            Opc.Ua.KeyValuePair kvpUserName = new Opc.Ua.KeyValuePair();
            ...
            Opc.Ua.KeyValuePair kvpPassword = new Opc.Ua.KeyValuePair();
            ...
            Opc.Ua.KeyValuePair kvpAzureClientId = new Opc.Ua.KeyValuePair();
            ...
            Opc.Ua.KeyValuePair kvpCleanSession = new Opc.Ua.KeyValuePair();
            ...
            Opc.Ua.KeyValuePair kvpProtocolVersion = new Opc.Ua.KeyValuePair();
